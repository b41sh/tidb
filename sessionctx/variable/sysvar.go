...
var defaultSysVars = []*SysVar{
	...
	{Scope: ScopeGlobal | ScopeSession, Name: SQLModeVar, Value: mysql.DefaultSQLMode, Type: TypeEnum, PossibleValues: []string{"ALLOW_INVALID_DATES", "ANSI_QUOTES", "ERROR_FOR_DIVISION_BY_ZERO", "HIGH_NOT_PRECEDENCE", "IGNORE_SPACE", "NO_AUTO_VALUE_ON_ZERO", "NO_BACKSLASH_ESCAPES", "NO_DIR_IN_CREATE", "NO_ENGINE_SUBSTITUTION", "NO_UNSIGNED_SUBTRACTION", "NO_ZERO_DATE", "NO_ZERO_IN_DATE", "ONLY_FULL_GROUP_BY", "PAD_CHAR_TO_FULL_LENGTH", "PIPES_AS_CONCAT", "REAL_AS_FLOAT", "STRICT_ALL_TABLES", "STRICT_TRANS_TABLES", "TIME_TRUNCATE_FRACTIONAL"}, IsHintUpdatable: true},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: "range_alloc_block_size", Value: "4096", Type: TypeUnsigned, MinValue: 4096, MaxValue: math.MaxUint64, AutoConvertOutOfRange: true, IsHintUpdatable: true},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: "join_buffer_size", Value: "262144", Type: TypeUnsigned, MinValue: 128, MaxValue: math.MaxUint64, AutoConvertOutOfRange: true, IsHintUpdatable: true},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: "max_length_for_sort_data", Value: "1024", Type: TypeUnsigned, MinValue: 4, MaxValue: 8388608, AutoConvertOutOfRange: true, IsHintUpdatable: true},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: "max_error_count", Value: "1024", Type: TypeUnsigned, MinValue: 0, MaxValue: 65535, AutoConvertOutOfRange: true, IsHintUpdatable: true},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: "max_heap_table_size", Value: "16777216", Type: TypeUnsigned, MinValue: 16384, MaxValue: math.MaxUint64, AutoConvertOutOfRange: true, IsHintUpdatable: true},
	{Scope: ScopeGlobal | ScopeSession, Name: "div_precision_increment", Value: "4", Type: TypeUnsigned, MinValue: 0, MaxValue: 30, AutoConvertOutOfRange: true, IsHintUpdatable: true},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: "sort_buffer_size", Value: "262144", Type: TypeUnsigned, MinValue: 32768, MaxValue: math.MaxUint64, AutoConvertOutOfRange: true, IsHintUpdatable: true},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: "max_join_size", Value: "18446744073709551615", Type: TypeUnsigned, MinValue: 1, MaxValue: math.MaxUint64, AutoConvertOutOfRange: true, IsHintUpdatable: true},
	{Scope: ScopeNone, Name: CoreFile, Value: BoolOff, Type: TypeBool},
	{Scope: ScopeGlobal | ScopeSession, Name: "max_seeks_for_key", Value: "18446744073709551615", Type: TypeUnsigned, MinValue: 1, MaxValue: math.MaxUint64, AutoConvertOutOfRange: true, IsHintUpdatable: true},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: "bulk_insert_buffer_size", Value: "8388608", Type: TypeUnsigned, MinValue: 0, MaxValue: math.MaxUint64, AutoConvertOutOfRange: true, IsHintUpdatable: true},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: "read_rnd_buffer_size", Value: "262144", Type: TypeUnsigned, MinValue: 1, MaxValue: 2147483647, AutoConvertOutOfRange: true, IsHintUpdatable: true},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: "read_buffer_size", Value: "131072", Type: TypeUnsigned, MinValue: 8192,  MaxValue: 2147479552, AutoConvertOutOfRange: true, IsHintUpdatable: true},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: "optimizer_search_depth", Value: "62", Type: TypeUnsigned, MinValue: 0, MaxValue: 62, AutoConvertOutOfRange: true, IsHintUpdatable: true},
	{Scope: ScopeGlobal | ScopeSession, Name: "max_points_in_geometry", Value: "65536", Type: TypeUnsigned, MinValue: 3, MaxValue: 1048576, AutoConvertOutOfRange: true, IsHintUpdatable: true},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: "optimizer_prune_level", Value: "1", Type: TypeUnsigned, MinValue: 0, MaxValue: 1, AutoConvertOutOfRange: true, IsHintUpdatable: true},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: "eq_range_index_dive_limit", Value: "200", Type: TypeUnsigned, MinValue: 0, MaxValue: 4294967295, AutoConvertOutOfRange: true, IsHintUpdatable: true},
